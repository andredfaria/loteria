...
from lotofacil_ml.backtest.engine import BacktestEngine
from lotofacil_ml.config import BACKTEST_DEFAULT_N, BACKTEST_MIN_TRAIN, BACKTEST_TRAIN_WINDOW
from lotofacil_ml.data.loader import Draw
from lotofacil_ml.evaluation.confusion import confusion_by_hits, confusion_per_number
from lotofacil_ml.evaluation.metrics import (
    LotofacilMetrics,
    mae_expected_hits,
    rmse_expected_hits,
    roc_auc_per_number,
