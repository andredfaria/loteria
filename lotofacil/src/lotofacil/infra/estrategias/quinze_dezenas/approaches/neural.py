...
from lotofacil.infra.estrategias.quinze_dezenas.config import (
    NEURAL_WINDOW_SIZE,
    NEURAL_LSTM_UNITS,
    NEURAL_DROPOUT,
...
from lotofacil.infra.config import TOTAL_NUMBERS, OUTPUT_MODELS, RANDOM_SEED
...
class NeuralApproach:
    ...
    def predict_with_filters(self, draws: List[Draw]) -> List[int]:
        ...
        from lotofacil.infra.dados.preprocessador import LotofacilPreprocessor
        from lotofacil.infra.estrategias.quinze_dezenas.post_processor import optimize
