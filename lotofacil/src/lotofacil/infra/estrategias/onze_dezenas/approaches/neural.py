...
class NeuralApproach:
    ...
    def _predict_from_model(self, preprocessor: LotofacilPreprocessor) -> np.ndarray:
        ...
        _, _, X_freq, X_atraso, X_climate = preprocessor.prepare_enriched_sequences(window_size=LSTM_WINDOW_SIZE)
    ...
    def predict_with_filters(self, draws: List[Draw]) -> List[int]:
        ...
        from lotofacil.infra.dados.preprocessador import LotofacilPreprocessor
        from lotofacil.infra.estrategias.onze_dezenas.post_processor import optimize
