...
from lotofacil.dominio.entidades import Draw, Prediction
from lotofacil.infra.config import TOTAL_NUMBERS
from lotofacil.dominio.estrategia import BaseStrategy
from lotofacil.infra.estrategias.onze_dezenas.config import (
    TARGET_NUMBERS,
    APPROACH_WEIGHTS,
    STRATEGY_NAME,
)
