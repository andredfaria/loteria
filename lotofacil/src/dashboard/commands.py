        ...
        "items": [
            {
                ...
                "description": "Predição 11 números combinando statistical + ML + neural — salva predicao_ensemble_<concurso>.json",
            ...
            },
            {
                "id": "predict_ml",
                "label": "Prever ML",
                "description": "Predição usando o ensemble ML — salva predicao_ml_<concurso>.json",
            ...
            },
            {
                ...
                "description": "Predição baseada em frequência e padrões estatísticos — salva predicao_statistical_<concurso>.json",
            ...
            },
            {
                "id": "predict_neural",
                "label": "Prever Neural",
                "description": "Predição via rede neural (LSTM/Attention) — salva predicao_neural_<concurso>.json",
