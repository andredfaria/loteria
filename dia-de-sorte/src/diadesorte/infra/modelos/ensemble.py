...
from diadesorte.infra.config import MODELOS_DIR
from diadesorte.infra.modelos.frequency_ensemble import FrequencyEnsembleModel
from diadesorte.infra.modelos.ml_model import MLEnsembleModel
from diadesorte.infra.modelos.probabilistic import ProbabilisticModel
...
class EnsemblePredictor:
    ...
    def select_top_7(self) -> List[int]:
        p = self.score()
